            ...
            <table class="table table-dark table-striped ">
                ...
                <tbody>
                    <?php foreach ($rows as $r) : ?>
                        <tr>
                            <th scope="col">
                                <a href="javascript:" onclick="remove_item(event)" ><i class="fa-solid fa-trash"></i></a>
                            </th>
                            <td><?= $r['sid'] ?></td>
                            <td><?= $r['name'] ?></td>
                            <td><?= $r['email'] ?></td>
...
<script>
    ...
    //     // if (trashCan.className === 'fa-solid fa-trash'){
    //     //     trashCan.closest('tr').remove();
    //     // }
    //     if (trashCan.classList.contains('fa-trash')){
    //         trashCan.closest('tr').remove();
    //     }
    // })
